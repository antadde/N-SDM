...
covdata.variable.filter<-Filter(length, lapply(covdata.candidates, covsel.filteralgo, pa=pa, weights=weights, force=force, corcut=0)) # corcut=0 select one covariate per variable
