...
2. A **clone of the N-SDM GitHub repository** in the working directory:
   ```bash
   # --- Stable release ---
   git clone --branch v2.0.2 https://github.com/antadde/N-SDM.git nsdm
...
3. An installation of the **nsdm R package**:
   ```r
   # --- Stable release ---
   remotes::install_github("antadde/N-SDM/Rpkg", ref = "v2.0.2")
...
Adde, A. et al. 2026. N-SDM 2.0: a reengineered software with extended features for nested species distribution modelling. – Ecography 2026: e08547 (ver. 2.0). [https://doi.org/10.1002/ecog.08547](https://doi.org/10.1002/ecog.08547)
