...
| `d16_nested-ensembles-sce` | Final nested ensemble maps for each scenario × period combination | `.tif` |
| `sacct` | SLURM job summaries (status, memory, CPU usage) for monitoring and debugging | `.psv` |
