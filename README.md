...
2. A **clone of the N-SDM GitHub repository** in the working directory:
   ```bash
   # --- Stable release ---
   git clone --branch v2.0.1 https://github.com/antadde/N-SDM.git nsdm
...
3. An installation of the **nsdm R package**:
   ```r
   # --- Stable release ---
   remotes::install_github("antadde/N-SDM/Rpkg", ref = "v2.0.1")
...
N-SDM v2.0 (and nsdm R package) has been successfully installed and executed on multiple high-performance computing (HPC) systems. The following configurations describe the module environments and R setups that were verified to work.
...
Adde, A. et al. 2026. N-SDM 2.0: a reengineered software with extended features for nested species distribution modelling. – Ecography 2026: In press (ver. 2.0). [https://doi.org/10.1002/ecog.08547](https://doi.org/10.1002/ecog.08547)
