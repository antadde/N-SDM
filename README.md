...
In this example N-SDM run we will model the current and future habitat suitability of three species (Larix decidua, Capra Ibex and Cantharellus cibarius) across Switzerland by using 100-m resolution environmental covariates.
